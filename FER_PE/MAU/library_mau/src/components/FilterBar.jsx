...
const FilterBar = () => {
    const { filters, sortBy, setFilter, setSort, getUniqueCategories, getUniqueStatuses } = useBook();
            ...
            <Card.Body>
                <Form>
                    <Row className="g-3">
                        ...
                        <Col xs={12} lg={4}>
                            <Form.Group>
                                <Form.Label>Tìm kiếm (Title/Author/ISBN)</Form.Label>
                                <Form.Control 
                                    type="text" 
                        ...
                        <Col xs={12} md={4} lg={4}>
                            <Form.Group>
                                ...
                                <Form.Select value={sortBy} onChange={handleSortChange}>
                                    ...
                                    <option value="publishedDate_asc">Published Date ascending</option>
                                    <option value="publishedDate_desc">Published Date descending</option>
                                </Form.Select>
                            </Form.Group>
                        </Col>
                    </Row>
