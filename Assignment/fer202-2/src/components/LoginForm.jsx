  ...
  const handleChange = (e) => {
    ...
    const validateForm = () => {
        ...
        if (!identifier.trim() && !password.trim()) {
            // This will be handled by individual field errors
        }
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(validationErrors).length > 0) {
            // Show error message if both fields are empty
            if (!formState.formData.identifier.trim() && !formState.formData.password.trim()) {
                // Error messages are already set in validationErrors
            }
            return;
        }
        ...
        <Col xs={12} md={6}>
          <Card>
            ...
            <Card.Body>
              ...
              {/* Show general error if both fields are empty */}
              {formState.errors.identifier && formState.errors.password && 
               !formState.formData.identifier.trim() && !formState.formData.password.trim() && (
